...
# 1. ПРЯМАЯ ПРОВЕРКА ФАЙЛОВ
print("\n1. Проверяю файлы в папке 'data/'...")

# Точные пути
file1 = r'data\track_data_final.csv'
file2 = r'data\spotify_data_clean.csv'
...
if not os.path.exists(file1):
    ...
    print("   Убедитесь что файл в папке 'data/'")
    exit()
...
try:
    ...
    print(f"   ✅ Загружено: {len(df1)} + {len(df2)} = {len(df1)+len(df2)} треков")
