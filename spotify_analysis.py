...
print("✓ отчёт.txt - текстовый отчёт")
...
print("\nЧто создано:")
print("• spotify_данные.csv - главный файл для бота")
print("• топ_артистов.csv - список лучших артистов")
print("• график_популярность.png - график популярности")
print("• график_длительность.png - график длительности")
print("• отчёт.txt - итоговый отчёт")

print("\nТеперь можно запускать Telegram-бота!")
print("Бот будет читать файл: spotify_данные.csv")
